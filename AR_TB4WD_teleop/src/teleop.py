...
if __name__=="__main__":
    ...
    try:
        ...
        while(1):
            ...
            control_linear_vel = makeSimpleProfile(control_linear_vel, target_linear_vel, (0.04/2.0))
            twist.linear.y = 0.0; twist.linear.x = control_linear_vel; twist.linear.z = 0.0

            control_angular_vel = makeSimpleProfile(control_angular_vel, target_angular_vel, (0.06/2.0))
            twist.angular.x = 0.0; twist.angular.y = 0.0; twist.angular.z = control_angular_vel

            control_y_vel = makeSimpleProfile(control_y_vel, target_y_vel, (0.04/2.0))
            twist.linear.y = control_y_vel
            pub.publish(twist)
